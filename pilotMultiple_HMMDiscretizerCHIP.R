...
for (fname in c("combined-300bin-filtered-hg19-H1-010.fastq.map.bed","combined-300bin-filtered-hg18-H1-004.fastq.map.bed","combined-300bin-filtered-hg19-H1-019.fastq.map.bed")){
   # load the dataset
