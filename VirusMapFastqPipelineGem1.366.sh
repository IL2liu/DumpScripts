...
###############################################
# Pipeline to map on the viral genomes        #
# gem version: 1.366                          # 
###############################################
...
do
  ...
  gem-mapper -I '/users/gfilion/rlim/Viruses/ViralGenomesIndexed.gem' -i $i -q 'offset-33' -o $output_dir/$i_file -T $core && echo "Gem mapping of $i:OK" >&2;
  map_f=$i_file.map
done                                            
